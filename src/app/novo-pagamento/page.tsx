...
export default function NovoPagamentoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.member_id) {
      alert('❌ Erro: Busque um membro pelo email ou cadastre um novo');
      return;
    }
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Busque o membro pelo email e cadastre o pagamento
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          ...
          {memberNotFound && (
            <div className="mt-4 p-4 bg-red-50 border border-red-200 rounded-lg">
              ...
              <Link
                href={`/novo-membro?redirect=/novo-pagamento`}
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="w-full px-4 py-3 border border-gray-200 bg-blue-50 rounded-lg text-blue-700 font-medium">
